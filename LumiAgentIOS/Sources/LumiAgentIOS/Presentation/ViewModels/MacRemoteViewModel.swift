...
public final class MacRemoteViewModel {
    ...
    public func remotePlay()     { runCommand { [weak self] in try await self!.client.mediaPlay() } }
    public func remotePause()    { runCommand { [weak self] in try await self!.client.mediaPause() } }
    public func remoteNext()     { runCommand { [weak self] in try await self!.client.mediaNext() } }
    public func remotePrevious() { runCommand { [weak self] in try await self!.client.mediaPrevious() } }
    ...
    public func sendTypeText() {
        ...
        runCommand { [weak self] in try await self!.client.typeText(text) }
        typeTextInput = ""
    }
    ...
    public func sendOpenApp() {
        ...
        runCommand { [weak self] in try await self!.client.openApplication(name) }
        openAppName = ""
    }
    ...
    public func runAppleScript() {
        ...
        runCommand { [weak self] in try await self!.client.runAppleScript(script) }
    }
    ...
    public func pressKey(_ key: String, modifiers: String = "") {
        runCommand { [weak self] in try await self!.client.pressKey(key, modifiers: modifiers) }
    }
}
